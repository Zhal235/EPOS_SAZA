...
class ProductsManager extends Component
{
    ...
    public function saveUnit()
    {
        ...
        try {
            ...
            // Auto-hitung harga jika user tidak isi manual
            ...
            if (!$this->editingUnitId && ($this->unitForm['is_sub_unit'] ?? false)) {
                ...
                ProductUnit::firstOrCreate(
                    ...
                    ['conversion_rate' => $convRate, 'is_base_unit' => false, 'selling_price' => $oldSellPrice, 'cost_price' => $oldCostPrice, 'wholesale_price' => $oldWholesale, 'is_active' => true, 'display_order' => 10]
                );

                ProductUnit::firstOrCreate(
                    ['product_id' => $product->id, 'unit_name' => $this->unitForm['unit_name']],
                    ['conversion_rate' => 1, 'is_base_unit' => true, 'selling_price' => $sellingPrice, 'cost_price' => $costPrice, 'wholesale_price' => $wholesalePrice, 'barcode' => $this->unitForm['barcode'] ?: null, 'is_active' => true, 'display_order' => 0]
                );
                ...
                session()->flash('message', "Berhasil! Stok dikonversi dari {$oldStock} {$oldUnit} menjadi {$product->stock_quantity} {$this->unitForm['unit_name']}.");
                return;
            }
